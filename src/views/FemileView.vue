...
<template>
  <main>
    <NavBarView />
    <header class="bg-gradient-femile" id="home">
    ...
    <div class="section" id="kelebihan">
      <div class="container text-align-center">
        <h2 class="font-weight-bold femile">Kelebihan FEMILE</h2>
        <div class="row">
          ...
          <div class="col-sm-8 col-lg-8 py-5">
            <p class="mb-4 text-dark">
              ...
              <strong>FEMILE</strong>, antara lain :<br />
              ✔️ Halal<br />
    ...
    <div class="section light-bg" id="harga">
      <div class="container">
        <div class="section-title">
          <h2 class="font-weight-bold">Harga Terjangkau!</h2>
        </div>
        ...
        <div class="keunggulan-berbelanja">
          <h4 class="text-dark text-align-center mt-5">
            Keunggulan Berbelanja <strong>FEMILE</strong> pada Kami :
          </h4>
          <p class="mb-4 text-dark">
    ...
    <div class="section" id="testi">
      <div class="container">
        <div class="section-title">
          <h2 class="font-weight-bold femile">Testimoni Pelanggan FEMILE</h2>
        </div>
    ...
    <div class="section bg-gradient-femile p-4">
      <div class="container">
        <div class="call-to-action">
          <h2 class="font-weight-bold femile mb-3">
            Tertarik untuk mencoba <strong>FEMILE</strong>?
          </h2>
          <br />
          ...
          <a
            ...
            class="btn btn-cart femile mt-3 mb-3"
          >
            Tokopedia</a
          >
        </div>
