...
<template>
  <main>
    <NavBarView />
    <header class="bg-gradient-hitawa" id="home">
        ...
        <div class="row gx-5 justify-content-center">
          <div class="col-xxl-8">
            <div class="text-center my-5">
              <h2 class="hitawa font-weight-bold">Tentang HITAWA</h2>
    ...
    <div class="section" id="kelebihan">
      <div class="container text-align-center">
        <h2 class="hitawa font-weight-bold">Kelebihan HITAWA</h2>
        <div class="row">
          ...
          <div class="col-sm-8 col-lg-8 py-5">
            <p class="mb-4 text-dark">
              ...
              <strong>HITAWA</strong>, antara lain :<br />
              ✔️ Halal<br />
            ...
            <a
              href="https://wa.me/+6281330865531?text=Halo%20saya%20tertarik%20dengan%20HITAWA..."
              class="btn btn-primary hitawa"
              ><svg
    ...
    <div class="section light-bg" id="harga">
      <div class="container">
        <div class="section-title">
          <h2 class="hitawa font-weight-bold">Harga Terjangkau!</h2>
        </div>

        <div class="card-deck">
          <div class="card pricing popular">
            <div class="card-head">
              <h4 class="hitawa font-weight-bold">Original HITAWA</h4>
              <span class="price hitawa">Rp. 45.000,-<sub>/pcs</sub></span>
            </div>

            <div class="card-body">
              <a
                href="https://wa.me/+6281330865531?text=Halo%20saya%20tertarik%20dengan%20HITAWA..."
                class="btn btn-primary hitawa btn-lg btn-block"
                >Pesan</a
              >
            </div>
          </div>
        ...
        <div class="keunggulan-berbelanja">
          <h4 class="hitawa text-dark text-align-center mt-5">
            Keunggulan Berbelanja <strong>HITAWA</strong> pada Kami :
          </h4>
          <p class="mb-4 text-dark">
    ...
    <div class="section" id="testi">
      <div class="container">
        <div class="section-title">
          <h2 class="hitawa font-weight-bold">Testimoni Pelanggan HITAWA</h2>
        </div>
    ...
    <div class="section bg-gradient-hitawa p-4">
      <div class="container">
        <div class="call-to-action">
          <h2 class="hitawa font-weight-bold mb-3">
            Tertarik untuk mencoba <strong>HITAWA</strong>?
          </h2>
          <br />

          <a
            href="https://wa.me/+6281330865531?text=Halo%20saya%20tertarik%20dengan%20HITAWA..."
            class="btn btn-hubungi hitawa mt-1 mb-3"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <a
            ...
            class="btn btn-cart hitawa mt-3 mb-3"
          >
            Tokopedia</a
          >
        </div>
